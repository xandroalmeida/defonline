...
it('devolve nome humanizado dos 8 indicadores conhecidos', function (string $codigo, string $nomeEsperado) {
...
it('formata Dívida Líq./EBITDA como múltiplo com 2 casas e símbolo ×', function () {
...
it('expõe a ordem canônica dos 7 essenciais — mesma ordem do motor', function () {
